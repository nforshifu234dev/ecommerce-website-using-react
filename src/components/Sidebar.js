...
const Sidebar = () => {
  ...
  return <div className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vw] transition-all duration-300 z-50 px-4 lg:px-[35px]`}>
    ...
    <div className='flex flex-col  gap-y-2 h-[61%] lg:h-[320px] overflow-y-auto overflow-x-hidden border-b'>
    ...
    <div className='flex flex-col gap-y-3 py-4 mt-4'>
      ...
      <div className='flex w-full justify-between items-center'>
        ...
        {/* clear cart icon */}
        <div onClick={clearCart} className='cursor-pointer py-4 bg-red-500 text-white w-12 h-12 flex items-center justify-center text-xl' ><FiTrash2/></div>
